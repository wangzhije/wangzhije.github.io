import{_ as e,V as n,W as d,a1 as i}from"./framework-ad6b4471.js";const s={},a=i(`<h1 id="node-modules-结构演变" tabindex="-1"><a class="header-anchor" href="#node-modules-结构演变" aria-hidden="true">#</a> node_modules 结构演变</h1><h2 id="第一阶段-npm-3-之前版本" tabindex="-1"><a class="header-anchor" href="#第一阶段-npm-3-之前版本" aria-hidden="true">#</a> 第一阶段：npm@3 之前版本</h2><ul><li>依赖树层级太深，会导致 Windows 上的目录路径过长问题</li><li>相同包在不同的依赖项中需要时，会存在多个相同副本</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>node_modules
└─ foo
   ├─ index.js
   ├─ package.json
   └─ node_modules
